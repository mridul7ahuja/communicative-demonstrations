...
class ValueIteration(object):
    def __init__(self, actions, transitionPdf, rewardFunction, valueTable, isTerminal, convergenceTolerance, gamma, alpha = 0, eps = 0, softmax = False):
